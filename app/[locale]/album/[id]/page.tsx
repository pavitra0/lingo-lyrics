        ...
        <div className="flex flex-col w-full min-h-screen bg-background text-foreground p-4 md:p-8 pb-32">
            ...
            <div className="flex flex-col md:flex-row items-center md:items-end gap-6 mb-8">
                <div className="relative h-48 w-48 shadow-2xl rounded-lg overflow-hidden flex-shrink-0">
                    <MusicImage src={coverImage} alt={album.name} fill className="object-cover" sizes="192px" fallbackIconSize={44} />
                </div>
                <div className="flex flex-col items-center md:items-start text-center md:text-left">
                    ...
                    <div className="flex items-center gap-2 text-zinc-500 dark:text-zinc-400 text-sm">
                        <span className="text-foreground font-medium">{album.primaryArtists}</span>
                        <span>•</span>
