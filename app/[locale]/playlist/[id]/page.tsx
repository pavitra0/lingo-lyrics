        ...
        <div className="flex flex-col w-full min-h-screen bg-background text-foreground p-4 md:p-8 pb-32">
            ...
            <div className="flex flex-col md:flex-row items-center md:items-end gap-6 mb-8">
                <div className="relative h-48 w-48 shadow-2xl rounded-lg overflow-hidden flex-shrink-0">
                    <MusicImage src={coverImage} alt={playlist.name} fill className="object-cover" sizes="192px" fallbackIconSize={44} />
                </div>
                <div className="flex flex-col items-center md:items-start text-center md:text-left">
                    <h2 className="text-zinc-500 uppercase tracking-widest text-sm font-medium mb-2">Playlist</h2>
                    <h1 className="text-3xl md:text-5xl font-bold mb-4">{playlist.name}</h1>
                    <p className="text-zinc-500 dark:text-zinc-400 mb-2 max-w-xl">{playlist.description}</p>
                    <div className="flex items-center gap-2 text-zinc-500 dark:text-zinc-400 text-sm">
                        <span className="text-foreground font-medium">{playlist.username}</span>
                        <span>•</span>
                    ...
                    <button
                        ...
                        className="mt-6 px-8 py-3 bg-foreground text-background rounded-full font-bold text-sm tracking-wide hover:scale-105 transition flex items-center gap-2"
                    >
